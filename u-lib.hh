...
// sys_kill(pid)
//    Kills a process. On success, returns 0. On failure, return -1.
//    Fails if process is not running or blocked.
inline int sys_kill(pid_t pid){
...
// sys_sleep(time)
//    Puts a thread to sleep for give number of ticks
inline int sys_sleep(size_t time){
